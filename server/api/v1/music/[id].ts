    ...
    try {
        ...
        return {
            ...
            data: {
                ...
                artworkLQ: album.attributes.artwork.url.replace("{w}", Math.floor(album.attributes.artwork.width / 10)).replace("{h}", Math.floor(album.attributes.artwork.height / 10)),
                ...
                barEditorArtworkLQ: album.attributes.editorialArtwork !== undefined ? album.attributes.editorialArtwork.bannerUber !== undefined ? album.attributes.editorialArtwork.bannerUber.url.replace("{w}", Math.floor(album.attributes.editorialArtwork.bannerUber.width / 10)).replace("{h}", Math.floor(album.attributes.editorialArtwork.bannerUber.height / 10)).replace("{f}", "png") : album.attributes.editorialArtwork.storeFlowcase !== undefined ? album.attributes.editorialArtwork.storeFlowcase.url.replace("{w}", Math.floor(album.attributes.editorialArtwork.storeFlowcase.width / 10)).replace("{h}", Math.floor(album.attributes.editorialArtwork.storeFlowcase.height / 10)).replace("{f}", "png") : '' : '', // yes this is actually fucked
